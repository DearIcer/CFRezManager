...
- Export LTB/LTA/LTC models from the right-click menu as FBX 7.4 (binary) files with skeleton, skin weights, all animations (one stack per animation), smooth-shaded normals, and embedded (packed) textures, ready for Blender, Unity, Unreal, and other tools.
